          ...
          {editMode ? (
            ...
            <div className="details-row">
              <div className="details-column">
                <div className="detail-group">
                  <label className="detail-label">Registration</label>
                  <div className="detail-value">{vehicleData.registration || 'Not provided'}</div>
                </div>
                
                <div className="detail-group">
                  <label className="detail-label">Make</label>
                  <div className="detail-value">{vehicleData.make || 'Not provided'}</div>
                </div>
                
                <div className="detail-group">
                  <label className="detail-label">Model</label>
                  <div className="detail-value">{vehicleData.model || 'Not provided'}</div>
                </div>
              </div>
              ...
              <div className="details-column">
                <div className="detail-group">
                  <label className="detail-label">Fuel Type</label>
                  <div className="detail-value">{vehicleData.fuelType || 'Not provided'}</div>
                </div>
                
                <div className="detail-group">
                  <label className="detail-label">Vehicle Type</label>
                  <div className="detail-value">{vehicleData.vehicleType || 'Not provided'}</div>
                </div>
                
                <div className="detail-group">
                  <label className="detail-label">Comments</label>
                  <div className="detail-value">{vehicleData.vehicleComments || 'No comments'}</div>
                </div>
              </div>
            </div>
          )}
